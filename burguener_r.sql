...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2023 a las 04:13:02
...
--
-- Volcado de datos para la tabla `bandera`
--

INSERT INTO `bandera` (`id_bandera`, `descripcion`) VALUES
(1, 'alta'),
(2, 'baja');
...
--
-- AUTO_INCREMENT de la tabla `bandera`
--
ALTER TABLE `bandera`
  MODIFY `id_bandera` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
